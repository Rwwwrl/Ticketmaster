---
name: commit
description: Create a commit for staged changes using the ticketmaster commit message format with scope, type, context, and description. Use only when the user explicitly invokes /commit.
---
